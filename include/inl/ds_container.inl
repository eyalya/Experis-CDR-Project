...
inline bool DsContainer::FindOperator(uint a_operator, OperatorRecord& a_op)
{    
    return m_operator.Find(a_operator, a_op);
}

inline bool DsContainer::FindSubscriber(uint a_subscriber, SubscriberRecord& a_sub)
{    
